...
export type CreateImageMutation = (
  ...
  & { createImage: (
    { __typename?: 'Image' }
    & Pick<Image, 'id' | 'label' | 'presignedUrl'>
  ) }
);
...
export type CreatePostMutation = (
  ...
  & { createPost: (
    { __typename?: 'SignedPost' }
    & Pick<SignedPost, 'id' | 'title' | 'userName' | 'mainImageId' | 'userPicture' | 'prettyTitle' | 'imagesNumber' | 'paragraphsNumber' | 'wordsNumber' | 'readingTime' | 'presignedUrl' | 'creationDate'>
    & { images: Array<(
      { __typename?: 'ImageMapping' }
      & Pick<ImageMapping, 'id' | 'label'>
    )> }
  ) }
);
...
export type GetUserPostsQuery = (
  ...
  & { getUserPosts: Array<(
    { __typename?: 'Post' }
    & Pick<Post, 'id' | 'title' | 'prettyTitle' | 'userName' | 'userPicture' | 'description' | 'mainImageId' | 'wordsNumber' | 'paragraphsNumber' | 'readingTime' | 'creationDate'>
  )> }
);
...
export type GetPostByUserNameAndTitleQuery = (
  { __typename?: 'Query' }
  & { getPostByUserNameAndTitle: (
    { __typename?: 'SignedPost' }
    & Pick<SignedPost, 'id' | 'title' | 'prettyTitle' | 'userName' | 'userPicture' | 'mainImageId' | 'imagesNumber' | 'paragraphsNumber' | 'wordsNumber' | 'presignedUrl' | 'readingTime'>
    & { images: Array<(
      { __typename?: 'ImageMapping' }
      & Pick<ImageMapping, 'id' | 'label'>
    )> }
 ...
 * });
 */
export function useGetImageByIdQuery(baseOptions: Apollo.QueryHookOptions<GetImageByIdQuery, GetImageByIdQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetImageByIdQuery, GetImageByIdQueryVariables>(GetImageByIdDocument, options);
      }
export function useGetImageByIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetImageByIdQuery, GetImageByIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetImageByIdQuery, GetImageByIdQueryVariables>(GetImageByIdDocument, options);
        }
...
export type GetImageByIdQueryResult = Apollo.QueryResult<GetImageByIdQuery, GetImageByIdQueryVariables>;
 ...
 * });
 */
export function useGetPostByUserNameAndTitleQuery(baseOptions: Apollo.QueryHookOptions<GetPostByUserNameAndTitleQuery, GetPostByUserNameAndTitleQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetPostByUserNameAndTitleQuery, GetPostByUserNameAndTitleQueryVariables>(GetPostByUserNameAndTitleDocument, options);
      }
export function useGetPostByUserNameAndTitleLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetPostByUserNameAndTitleQuery, GetPostByUserNameAndTitleQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetPostByUserNameAndTitleQuery, GetPostByUserNameAndTitleQueryVariables>(GetPostByUserNameAndTitleDocument, options);
        }
export type GetPostByUserNameAndTitleQueryHookResult = ReturnType<typeof useGetPostByUserNameAndTitleQuery>;
export type GetPostByUserNameAndTitleLazyQueryHookResult = ReturnType<typeof useGetPostByUserNameAndTitleLazyQuery>;
export type GetPostByUserNameAndTitleQueryResult = Apollo.QueryResult<GetPostByUserNameAndTitleQuery, GetPostByUserNameAndTitleQueryVariables>;
